...
sudo mkdir -p /Examenes-UTN/alumno_1/parcial_2
sudo mkdir -p /Examenes-UTN/alumno_1/parcial_3
sudo mkdir -p /Examenes-UTN/alumno_2/parcial_1
sudo mkdir -p /Examenes-UTN/alumno_2/parcial_2
sudo mkdir -p /Examenes-UTN/alumno_2/parcial_3
sudo mkdir -p /Examenes-UTN/alumno_3/parcial_1
sudo mkdir -p /Examenes-UTN/alumno_3/parcial_2
